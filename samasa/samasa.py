...
class subanta:
    ...
    vibhakthi = { 'prathama':1,'sambhodana':2,'dvitiya':3,'tritiya':4,'chaturthi':5,\
                  'panchami':6,'shashti':7,'sapthami':8}
            ...
            if (len(lemma_table.get_text())):
                ...
                for tr in lemma_table.find_all('tr'):
                    ...
                    for td in tr.find_all('td'):
                        row_data.append(d_to_s(td.text))                        
    ...
    def get_sup_tables(self):
        ...
        #lemma_params_m="lex=SH&q=" + input_word + "&t=VH&g=Mas&font=deva"
        #lemma_params_f="lex=SH&q=" + input_word + "&t=VH&g=Fem&font=deva"
        #lemma_params_n="lex=SH&q=" + input_word + "&t=VH&g=Neu&font=deva"
...
def d_to_s(input_string):
    ...
    if (str(scheme) == "Devanagari"):
      v_scheme_map = sanscript.SchemeMap(
                      ...
                      sanscript.SCHEMES[sanscript.SLP1])
...
class SamasaGenerator():
    ...
    def a2(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v3() + d_to_s(" विपरीतं वृत्तं");
        return sp; 
    def a3(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v6() + " " + sub_up.v1() + d_to_s("यस्मिन् देशे");
        return sp;
    def a4(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v6() + " " + sub_up.v6() + d_to_s("समाहारः");
        return sp;
    def a5(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + " " + sub_up.v1() + " " + d_to_s("यस्मिन् देशे");
        return sp;
    def a6(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
    ...
    def tds(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp = sub_pp.v6("bahu") + " " + sub_up.v6("bahu") + d_to_s(" समाहारः");
        return sp; 
    def tdt(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  d_to_s("अष्ठसु ") + sub_up.v7("bahu") + d_to_s(" संसृतः");
        return sp; 
    def tdu(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
    ...
    def k1(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)  
        sp =   sub_pp.v1() + d_to_s("तत्") + sub_up.v1() + d_to_s("च");
        return sp;
    def k2(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + d_to_s(" च ") + sub_up.v1() + d_to_s("च");
        return sp;
    def k3(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + d_to_s(" च असौ ") + sub_up.v1() + d_to_s("च");
        return sp;
    def k4(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + d_to_s(" इव ") + sub_up.v1() ;
        return sp;
    def k5(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + " " + sub_up.v1() + d_to_s(" इव ");
        return sp;
    def k6(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + d_to_s(" एव ") + sub_up.v1() ;
        return sp;
    def k7(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + d_to_s(" इति ") + sub_up.v1() ;
        return sp;
    def km(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)  
        ...
        if ((not y1) or (y1 == "[]")):
            y1  = up     
        sp =  sub_pp.v1() + d_to_s(" प्रियः ") + y1 ;
        return sp;
    def bs2(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + " " + sub_up.v1() + d_to_s(" यम्") ;
        return sp;
    def bs3(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + " " + sub_up.v1() + d_to_s(" येन ") ;
        return sp;
    def bs4(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + " " + sub_up.v1() + d_to_s(" यस्मै ")  ;
        return sp;
    def bs5(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + " " + sub_up.v1() + d_to_s(" यस्मात् ")  ;
        return sp;
    def bs6(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + " " + sub_up.v1() + d_to_s(" यस्य ") ;
        return sp;
    def bs7(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + " " + sub_up.v1() + d_to_s(" यस्मिन् ") ;
        return sp;
    def bsd(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v6() + d_to_s(" च ") + sub_up.v6() + d_to_s(" च यदन्तरालं ");
        return sp;
    def bsp(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + d_to_s(" च ") + sub_up.v3() + d_to_s(" च प्रहृत्य इदं युद्धं प्रवृत्तं ");
        return sp;
    def bsg(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v7() + d_to_s(" च ") + sub_up.v7() + d_to_s(" च गृहीत्वा इदं युद्धं प्रवृत्तं  ");
        return sp;
    def bsmn(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  self.f_bsmn(pp) + " " + sub_up.v1() + d_to_s(" यस्य ") ;
        return sp;
    def bvp(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
    ...
    def bss(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + d_to_s(" वा ") + sub_up.v1() + d_to_s(" यस्य ") ;
        return sp;
    def bsu(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v1() + d_to_s(" इव ") + sub_up.v1() + d_to_s(" यस्य ") ;
        return sp;
    def bv(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
    ...
    def bvs(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_up.v6() + " " + up + d_to_s(" यस्य ");
        return sp;
    def bvs_Caps(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v3() + d_to_s(" सह ") ;
        return sp;
    def bvu(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
        sp =  sub_pp.v6() + d_to_s(" इव ") + up + d_to_s(" यस्य ");
        return sp;
    def bb(self,pp, up):
        sub_pp =subanta(pp)  
        sub_up =subanta(up)         
...
class SamasaLexer(Lexer):
    tokens = { TAG,\
               ...
               TDS,TDU,TDT,\
#               E,S,U,D,\
               WORD, NUMBER, HIPHEN, LPAREN, RPAREN, DANDA, DDANDA, PLUS }
    ignore = ' \t'
...
class SamasaParser(Parser):
    ...
    @_('DDANDA NUMBER DDANDA')
    def shlokaend(self, p):
        samasthapada = p.DDANDA + str(p.NUMBER) + p.DDANDA
        print("Got a shloka ending " + samasthapada)        
        return samasthapada
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            translated_text = d_to_s(input_text)
        except EOFError:
            break
        if translated_text:
            outStr = ca.analyze(translated_text)
            #print("outStr=" + s_to_d(outStr))
